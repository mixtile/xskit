...
public slots:
    ...
    void find(const QString &needle, const QStringList &searchFlags, const QString animate = "false");

    void findPrevious();

    void findPrevious(const QString &needle, const QStringList &searchFlags, const QString animate = "false");

    void findNext();

    int findAll(const QString &needle, const QStringList &searchFlags, const QString keeps = "false");

    void replace(const QString &replacement);

    void replace(const QString &replacement, const QString &needle, const QStringList &searchFlags);

    void replaceAll(const QString &replacement);

    void replaceAll(const QString &replacement, const QString &needle, const QStringList &searchFlags);
...
signals:
    ...
    void cutEnabled(bool);

    void pasteEnabled(bool);

    void postUndoStatus(bool);

    void updteFontSize(bool);
